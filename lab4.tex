...
% 100 nanoseconds
% 100 multiplier
% 0.02 microseconds per channel
% 2.2 microseconds is around channel 110
...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=2.3in]{A.png}}\hfill
	\subfloat{\includegraphics[width=2.3in]{B.png}}\hfill
	\subfloat{\includegraphics[width=2.3in]{C.png}}
...
A best-fit line was applied to the filtered data, providing a slope of $-2.25 \pm 0.04$ \textmu s. The standard error of the slope was provided by applying a regression analysis to the data.
